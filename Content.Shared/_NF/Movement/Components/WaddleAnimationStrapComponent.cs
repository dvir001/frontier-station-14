...
[ByRefEvent]
public record struct StartedWaddlingStrapEvent(EntityUid Entity)
{
...
[ByRefEvent]
public record struct StoppedWaddlingStrapEvent(EntityUid Entity)
{
    public EntityUid Entity = Entity;
}
...
/// </summary>
[RegisterComponent]
public sealed partial class WaddleAnimationStrapComponent : Component
{
    /// <summary>
